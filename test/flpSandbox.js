		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#campbrasileiro-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"campbrasileiro-display": {
								"semanticObject": "campbrasileiro",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=campbrasileiro",
									"url": sap.ui.require.toUrl("campbrasileiro")
								}
							}
						}
					}
